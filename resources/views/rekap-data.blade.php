...
<div id="rekapTab" class="hidden fade-in">
    <div class="bg-white rounded-xl shadow-lg p-8">
        ...
        <div class="mb-6 flex flex-wrap gap-4 items-center justify-between">
            <div class="flex gap-4 items-center"><label for="filterDepartment" class="text-sm font-medium text-gray-700">Filter Departemen:</label> <select id="filterDepartment" onchange="updateRekapData()" class="px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
