<div id="input2Tab" class="hidden fade-in">
    <div class="bg-white rounded-xl shadow-lg p-8">
        ...
        <div class="mb-6"><label for="nomorDokumen" class="block text-sm font-medium text-gray-700 mb-2">Nomor Dokumen</label> <select id="nomorDokumen" onchange="loadTemuanData()" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
