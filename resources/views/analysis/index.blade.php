...
<div id="analisaTab">
    <div class="bg-white rounded-xl shadow-lg p-8">
        <div class="mb-6">
            <h2 class="text-2xl font-bold text-gray-800 flex items-center"><span
                    class="w-8 h-8 bg-orange-500 rounded-full flex items-center justify-center text-white text-sm mr-3">📈</span>
                Analisa Hasil Temuan Bulanan</h2>
        </div><!-- Filter Periode -->
        <div class="mb-6 flex flex-wrap gap-4 items-center">
            <div class="flex gap-2 items-center"><label for="filterPeriode"
                    class="text-sm font-medium text-gray-700">Periode:</label> <select id="filterPeriode"
            ...
            <div id="filterBulananContainer" class="flex gap-2 items-center"><label for="filterBulan"
                    class="text-sm font-medium text-gray-700">Bulan:</label> <select id="filterBulan"
                    onchange="updateAnalisaBulanan()"
                    class="px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
            ...
            <div class="flex gap-2 items-center"><label for="filterTahun"
                    class="text-sm font-medium text-gray-700">Tahun:</label> <select id="filterTahun"
                    onchange="updateAnalisaBulanan()"
                    class="px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                    ...
                    <thead>
                        <tr class="bg-gray-50">
                            ...
                            <th class="border border-gray-300 px-4 py-3 text-center text-sm font-medium text-gray-700">
                                Total Temuan</th>
                            <th class="border border-gray-300 px-4 py-3 text-center text-sm font-medium text-gray-700">
                                Temuan Terselesaikan</th>
                            <th class="border border-gray-300 px-4 py-3 text-center text-sm font-medium text-gray-700">%
                                Selesai</th>
                            <th class="border border-gray-300 px-4 py-3 text-center text-sm font-medium text-gray-700">
                                Total Waktu Penyelesaian (Hari)</th>
                            <th class="border border-gray-300 px-4 py-3 text-center text-sm font-medium text-gray-700">
                                Total Poin Ketidaksesuaian</th>
                        </tr>
                    </thead>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="bg-gray-50 rounded-lg p-6">
                ...
                <div id="completionChart" class="space-y-3">
                    <!-- Chart will be populated by JavaScript -->
                </div>
            </div>
        </div>
